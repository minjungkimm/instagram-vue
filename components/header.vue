<template>
  <nav class="nav">
    <div class="nav-container">
      <div class="nav-container-depth">
        <div class="nav-container-item-mobile m-show">
          <div class="item-box start">
            <svg
              aria-label="새 스토리"
              fill="#262626"
              height="24"
        ...
        <div class="nav-container-item m-none">
        ...
        <div class="nav-container-item m-none input">
          <div class="input-box">
            <input class="search-input" type="text" placeholder="검색" />
          </div>
        </div>
        <div class="nav-container-item icons m-none">
          <svg
            class="icon"
            aria-label="홈"
            fill="#262626"
          ...
          <img
            class="icon my-profile"
            alt="min님의 프로필 사진"
            src="https://scontent-nrt1-1.cdninstagram.com/v/t51.2885-19/44884218_345707102882519_2446069589734326272_n.jpg?_nc_ad=z-m&amp;_nc_ht=scontent-nrt1-1.cdninstagram.com&amp;_nc_ohc=-dngjj927I8AX-oBVUa&amp;oh=4a1c7df8b770194aa907d9001a2646af&amp;oe=5EFFE60F&amp;ig_cache_key=YW5vbnltb3VzX3Byb2ZpbGVfcGlj.2"
          />
        </div>
      </div>
    </div>
